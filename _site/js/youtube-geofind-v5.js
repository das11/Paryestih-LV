...
const geofind = (function () {
            ...
            function get(index, slice) {
                ...
                youtube.ajax("videos", {
                    ...
                    (res.items || []).forEach(function (video) {
                        ...
                        // if(!uniqueVideoIds.hasOwnProperty(video.id)){
    ...
    function doneProgressMessage() {
        return [
            rawVideoData.length + " processed video(s)",
    ...
    const internal = {
        ...
        init: function (mapElement) {
            ...
            console.log(typeMeta);
             if (controls.inputChannels.length || typeMeta === "channel") {
                ...
                OVERRIDE_GEOTAG = true;
                console.log("GEOTAG OVERRIDEN - For Channel");
        ...
        setupPageControls: function () {
            ...
            controls.btnExport.on('click', function () {
                ...
                zip.file("about.txt",
                    "Downloaded by Paryestih " + new Date().toLocaleString() + "\n\n" +
                    "URL: " + window.location + "\n\n" +
        ...
        locationToPosition: function (video) {
            ...
            if(OVERRIDE_GEOTAG){
                return {
                    lat: 48.06769903025529,
                    lng: 12.861547378463419
                }
            }
            return {
